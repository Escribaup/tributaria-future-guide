                  ...
                  <div className="bg-white rounded-lg shadow-md p-6 md:p-8">
                    ...
                    <div className="prose max-w-none text-idvl-text-dark">
                      ...
                      <div className="relative">
                        {/* Timeline line */}
                        <div className="absolute top-0 bottom-0 left-6 w-0.5 bg-idvl-blue-light"></div>

                        {/* Timeline items */}
                        <div className="space-y-12">
                          {/* 2023 */}
                          <div className="relative pl-16">
                            <div className="absolute left-0 bg-idvl-blue-dark text-white rounded-full w-12 h-12 flex items-center justify-center font-bold">
                              2023
                            </div>
                            <h3 className="text-xl font-bold text-idvl-blue-dark mb-3">Aprovação da Reforma</h3>
                            <ul className="list-disc pl-6 space-y-2">
                              <li>Aprovação da Emenda Constitucional 132/2023 pelo Congresso Nacional</li>
                              <li>Definição do arcabouço geral da reforma</li>
                              <li>Início dos trabalhos de elaboração das leis complementares</li>
                            </ul>
                          </div>
                          ...
                          <div className="relative pl-16">
                            ...
                            <h3 className="text-xl font-bold text-idvl-blue-dark mb-3">Regulamentação</h3>
                            <ul className="list-disc pl-6 space-y-2">
                              <li>Aprovação das leis complementares que regulamentam os novos tributos</li>
                              <li>Definição das alíquotas de referência e exceções</li>
                              <li>Criação do Comitê Gestor do IBS</li>
                              <li>Desenvolvimento dos sistemas necessários à implementação</li>
                            </ul>
                          </div>
                          ...
                          <div className="relative pl-16">
                            ...
                            <h3 className="text-xl font-bold text-idvl-blue-dark mb-3">Início da Transição</h3>
                            <ul className="list-disc pl-6 space-y-2">
                              <li>Implementação do IBS e da CBS com alíquota teste de 0,1%</li>
                              <li>Manutenção integral dos tributos atuais</li>
                              <li>Teste dos sistemas e procedimentos</li>
                            </ul>
                          </div>

                          {/* 2027-2032 */}
                          <div className="relative pl-16">
                            <div className="absolute left-0 bg-idvl-blue-dark text-white rounded-full w-12 h-12 flex items-center justify-center text-sm font-bold">
                              27-32
                            </div>
                            <h3 className="text-xl font-bold text-idvl-blue-dark mb-3">Transição Gradual</h3>
                            <ul className="list-disc pl-6 space-y-2">
                              <li>2027: Início da redução do PIS/Cofins e início da CBS com alíquota parcial</li>
                              <li>2029: Início da redução do ICMS/ISS e aumento gradual do IBS</li>
                              <li>Redução progressiva dos tributos antigos e aumento progressivo dos novos</li>
                              <li>Adaptação dos sistemas empresariais e governamentais</li>
                            </ul>
                          </div>
                          ...
                          <div className="relative pl-16">
                            ...
                            <h3 className="text-xl font-bold text-idvl-blue-dark mb-3">Implementação Completa</h3>
                            <ul className="list-disc pl-6 space-y-2">
                              <li>Extinção completa dos tributos antigos (PIS, Cofins, IPI, ICMS e ISS)</li>
                              <li>IBS e CBS em pleno funcionamento</li>
                              <li>Implementação completa do Imposto Seletivo</li>
                              <li>Novo sistema tributário em vigor</li>
                            </ul>
                          </div>
                        </div>
                      </div>
